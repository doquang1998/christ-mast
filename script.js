...
function createGift() {
  ...
  const messages = [
    "🌟 Chúc em một Giáng Sinh thật an lành, tràn ngập niềm vui và những điều ngọt ngào.",
    "🎁 Giáng Sinh này, điều ước duy nhất của anh là được thấy em luôn hạnh phúc và bình an.",
    "❄️ Chúc người anh thương một Giáng Sinh tràn ngập yêu thương.",
  ];
